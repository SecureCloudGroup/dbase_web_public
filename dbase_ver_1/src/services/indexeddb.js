...
//     // const chunkSize = 16 * 1024; // Reduced chunk size to 16 KB, for WebRTC Channel max
//     let offset = 0;
//     let chunkIndex = 0;
//     const fileId = await generateFileId();
//     const fileSize = file.size;
//     const kvPairs = []; // Array to store key-value pairs of encrpted chunks/IDs
//     const chunkMetadata = {}; // Object to store chunk metadata for binary tree structure
...
//                     const encryptedChunk = await encryptChunk(compressedChunk, key);
//                     console.log("indexeddb - processAndStoreFile - key: ", key);
//                     console.log("indexeddb - processAndStoreFile - encryptedChunk: ", encryptedChunk);
                    
//                     // Ensure encryptedChunk.data is a Uint8Array
...
//                     // Generate CIDv1 for the encrypted chunk - '1' is VERSION
//                     const hash = await sha256.digest(encryptedDataArray);
                    

//                     // Generate CIDv1 for the encrypted chunk - '1' is VERSION
//                     // const hash = await sha256.digest(new Uint8Array(encryptedChunk));
//                     console.log("indexeddb - processAndStoreFile - hash: ", hash);
//                     const cid = CID.create(1, raw.code, hash);

//                     // const chunkCID = `${fileName}_${chunkIndex}`;
...
//                     console.log("indexeddb - processAndStoreFile - saveFileToDBase: ",saveFileToDBase);
//                     if (saveFileToDBase){
//                         const chunkMeta = {
//                             owner: bNodeId,
//                             fileName: fileName,
...
//                         }
//                         // kvPairs.push({ chunkCID, encryptedChunk }); // Store the key-value pair
//                         // kvPairs.push({ chunkMeta, encryptedChunk }); // Store the key-value pair
//                         kvPairs.push({ key: chunkCID, value: chunkMeta }); // Store the key-value pair
//                     }
                    
//                     const encodedFileName = encodeFileName(fileName); // Store File in Folder
//                     if (!localStoreHandle) {
//                         localStoreHandle = await getLocalStoreHandle('local');
//                         localStoreHandle = localStoreHandle.dbaseFolderHandle;  // Ensure the dbase folder handle is used
//                     }
//                     console.log("indexeddb - processAndStoreFile - localStoreHandle: ",localStoreHandle);
//                     await saveChunkToLocalStore(encodedFileName, chunkIndex, encryptedChunk, localStoreHandle);  // Store File in Folder
...
//                             console.log("indexeddb - processAndStoreFile - wallet_address: ",wallet_address);
//                             if (wallet_address) {
//                                 const list_of_peers = await get_peers_for_dbase_file(wallet_address);
//                                 console.log("indexeddb - processAndStoreFile - list_of_peers: ",list_of_peers);
//                                 if(list_of_peers.length >= 1) {
//                                     console.log("indexeddb - processAndStoreFile - calling copy_file_to_peers...");
//                                     copy_file_to_peers(setReadyToCommunicate, list_of_peers, kvPairs, peerStoreFolder);
//                                     console.log("indexeddb - processAndStoreFile - kvPairs: ", kvPairs);
//                                 } else {
//                                     console.log("indexeddb - processAndStoreFile - NO list_of_peers: ", list_of_peers);
//                                 }
//                             } else {
//                                 console.log("indexeddb - processAndStoreFile - NO wallet_address: ", wallet_address);
//                             }
//                         } else {
//                             console.log("indexeddb - processAndStoreFile - NO dBase Secure Cloud");
//                         }
